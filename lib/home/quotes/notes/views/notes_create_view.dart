                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        (context.watch<NoteController>().isClicked == true)
                            ? GestureDetector(
                              onTap: () {
                                context.read<NoteController>().setIsClicked(false);
                              },
                              child: Column(
                                  children: [
                                    Text(
                                        ...
                                        onPressed: () {
                                          ...
                                          NoteModel notes=NoteModel(note: _noteController.text,
                                           ...
                                           String data=noteModelToJson(notes);
                                            context.read<NoteController>().createNote(data);
                                           context.read<NoteController>().setIsClicked(true);
                                           Navigator.of(context).pop();
                                          setState(() {
