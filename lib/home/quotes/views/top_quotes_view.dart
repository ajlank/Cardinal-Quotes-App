...
import 'package:cardinal_quotes_app/home/quotes/rest_api_all_quotes/hooks/fetch/fetch_quotes_by_category.dart';
...
class QuotesView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    String? accessToken=GetStorage().read('accessToken');
     ...
     final check= context.read<BottomNavNotifier>().getQuotesCategory.isNotEmpty?context.read<BottomNavNotifier>().getQuotesCategory:'top_quotes';
